...
import com.atmecs.taxi.R;

public class MobileEntryEditText extends AppCompatEditText {

    public static final String XML_NAMESPACE_ANDROID = "http://schemas.android.com/apk/res/android";

    float mSpace = 14; //24 dp by default
    float mCharSize = 0;
    float mNumChars = 10;
    ...
    public MobileEntryEditText(Context context) {
        super(context);
    }

    public MobileEntryEditText(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs);
    }
...
//    }
    ...
    protected void onDraw(Canvas canvas) {
        //super.onDraw(canvas);
        int availableWidth = getWidth() - (getPaddingRight()*6) - (getPaddingLeft()*6);
        if (mSpace < 0) {
